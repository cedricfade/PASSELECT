        ...
        <div class="col-xl-12">
          <div class="form col-xl-4 col-lg-6 col-md-6 col-10">
           ...
           @endif
            ...
            <h5 class="text-center"><span style="border-top:1px dashed; padding:4px 15px; border-bottom:1px dashed; padding:4px 15px; border-left:1px dashed; padding:4px 15px; ">Connexion</span><span style="background-color: rgb(73, 15, 85); color:#fff; padding:5px 15px">Participant</span></h5>
